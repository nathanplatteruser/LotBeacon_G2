      ...
      <section className="mt-4 rounded-xl border border-border bg-card p-5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[12px] text-muted-foreground">Units / rep in the Before & after model. 2.8× conversations / hour. +45% Messenger foot traffic. Close rate held flat.</p>
          </div>
        </div>
      </section>
